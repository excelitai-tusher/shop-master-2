class GroceryTopSellingProduct {
  List<GroceryPopularProduct>? popularProduct;
  ...
  GroceryTopSellingProduct.fromJson(Map<String, dynamic> json) {
    if (json['Popular_product'] != null) {
      popularProduct = <GroceryPopularProduct>[];
      json['Popular_product'].forEach((v) {
        popularProduct!.add(new GroceryPopularProduct.fromJson(v));
      });
    }
  }
...
class GroceryPopularProduct {
  ...
  GroceryPopularProduct.fromJson(Map<String, dynamic> json) {
